...
//         $response = $this->actingAs($user)->delete(route('companies.users.destroy', [$company->id, $userToDelete->id]));
...
//         $response = $this->actingAs($user)->delete(route('companies.users.destroy', [$company2->id, $userFromOtherCompany->id]));
