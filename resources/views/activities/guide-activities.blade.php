                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                        @forelse($activities as $activity)
                            <div class="space-y-3">
                                ...
                                <a href="{{ route('activity.show', $activity) }}" class="block overflow-hidden rounded-t-xl">
                                    <img src="{{ $activity->thumbnail }}" alt="{{ $activity->name }}" class="object-cover transition-transform duration-300 hover:scale-105"> </a>
